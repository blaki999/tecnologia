...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			p1: "/chatskins/5698/Shutterstock-TT-07-2026-precart-blank-dsktp-p1-3x.webp",
			p2: "/chatskins/5698/Shutterstock-TT-07-2026-precart-blank-dsktp-10off-p2-3x.webp",
			intrinsic_size: {
				background: {
					height: 11,
					width: 11
			...
			css: ".usi_display * {  font-size: 1em;  line-height: 1.2;  box-sizing: border-box;  color: inherit;  font-family: Roboto, Arial;}.usi_display {  color: #000;  font-family: Roboto, Arial;}.usi_coupon {  display: block;  position: absolute;  top: 60.5%;  left: 6%;\twidth: 38%;  height: 8%;  font-size: 1.5em;  font-weight: bold;  padding: 8px 24px 7px 111px;  cursor: pointer;  background: none;}.usi_header_text span {  font-family: inherit;  color: #000;  letter-spacing: -1px;}.usi_header_text2 span {  font-weight: bold;  font-family: inherit;  color: #000;  letter-spacing: -1px;}.usi_header_text { \tposition: absolute;\ttop: 28%;  left: 5%;  width: 43%;  height: 15%;  font-size: 0.7em;  color: #000;  text-align: left; }.usi_text_bottom {\tposition: absolute;  top: 41%;  left: 5%;  width: 43%;  height: 28%;  font-size: 2.7em;  color: #000;}.usi_text_bottom.p2 {\ttop: 24% !important;}.usi_header_text span {  text-align: left !important;}.usi_text_bottom span {\tfont-weight: bold;  text-align: left !important;}.usi_header_text2 {  position: absolute;  top: 28%;  left: 9%;  width: 74%;  height: 33%;  color: #000;}.usi_bullet_container {  position: absolute;  display: block;  top: 42%;  left: 9%;  }.usi_bullet_text {  display: block;  font-size: 1.7em;  color: #000;  padding-bottom: 6px;  width: 100%;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {  background: none;  border: none;}.usi_submitbutton {  position: absolute;\ttop: 71.5%;  left: 5%;  width: 39%;  height: 13.5%;  display: inline-block;  background: none;  border: none;  margin: 0;  padding: 0;  cursor: pointer;  text-align: center;  color: #fff;  font-weight: bold;  font-size: 1.4em;}",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
		...
		launch_cookie_set:function() {
			try {
				...
				if (usi_js.campaign.use_company_cookie == 2) usi_cookies.set("usi_launched", usi_js.campaign.id);
			} catch(err) {
				if (typeof(usi_commons) !== "undefined") usi_commons.report_error(err);
			}
		},
...
if(usi_app.is_enabled) {  
  if(usi_app.messaging.header1_p2_test) {
    usi_app.messaging.header1_p2 = usi_app.messaging.header1_p2_test; 
  }
  
  if(usi_app.messaging.header2_p2_test) {
...
usi_js.display_vars.p2_html = [
  ...
  '<button class="usi_coupon" onclick="usi_js.write_clipboard();">', (""), '</button>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta_p2();" type="button">',usi_app.messaging.cta,'</button>',
		...
		set_backtrap:function() {
			try {
				...
				usi_js.heart_beat();
				if (usi_js.launch.back_track == 1 && usi_cookies.get("usi_back_clicked") == usi_js.campaign.hash + "_" + usi_js.campaign.site_id + "_" + usi_js.campaign.config_id && usi_cookies.get("usi_back_url") != location.href.split("#")[0]) {
					setTimeout(function() { usi_cookies.del("usi_back_clicked"); }, 1500);
													...
													if (typeof(usi_app) !== "undefined") {
														...
														for (var i = 0; i < usi_commons.objects.length; i++) {
															if (typeof (usi_app[usi_commons.objects[i]]) !== "undefined") {
																usi_cookies.set("usi_app_" + usi_commons.objects[i], JSON.stringify(usi_app[usi_commons.objects[i]]), 10);
															}
														}
													}
													usi_cookies.set("usi_back_clicked", usi_js.campaign.hash + "_" + usi_js.campaign.site_id + "_" + usi_js.campaign.config_id, 10);
													usi_cookies.set("usi_back_url", location.href.split("#")[0], 10);
													history.back();
												} else {
